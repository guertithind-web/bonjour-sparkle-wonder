...
const translations: Record<Lang, Dict> = {
  fr: {
    ...
    "contact.volume": "Volume de transactions par jour",
    "contact.vol.1": "entre 0 et 20",
    "contact.vol.2": "entre 20 et 50",
    "contact.vol.3": "entre 50 et plus",
  ...
  en: {
    ...
    "contact.email": "Email",
    "contact.phone": "Phone",
    "contact.volume": "Daily transaction volume",
    "contact.vol.1": "between 0 and 20",
    "contact.vol.2": "between 20 and 50",
    "contact.vol.3": "50 and more",
    "contact.message": "Message",
    "contact.send": "Send",
  ...
  ar: {
    ...
    "contact.volume": "حجم المعاملات اليومي",
    "contact.vol.1": "بين 0 و 20",
    "contact.vol.2": "بين 20 و 50",
    "contact.vol.3": "50 فأكثر",
