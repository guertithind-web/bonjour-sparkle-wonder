          ...
          {solutions.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                className="h-[360px] bg-card rounded-2xl border border-primary overflow-hidden flex flex-col hover:shadow-xl hover:shadow-primary/5 transition-all duration-300"
              >
